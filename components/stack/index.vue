<template>
  <div>
    ...
    >
      <p>
        Начнем со стека основных технологий, используемых фронтами в Crypton.Studio.
      </p>
      <p>
      ...
      <ul>
        ...
        <li>
          ...
          >
            Vue
          </a> - Не знаешь Vue -> в NuxtJS пока не лезь.
        </li>
        <li>
          <a
        ...
        <li>
          ...
          >
            BootstrapVue
          </a> - Почти в каждом проекте. Используем редко. В основном - из-за таблиц.
        </li>
        <li>
          <a
          ...
          >
            SASS (Синтаксис SCSS)
          </a> - Метаязык на основе CSS. Используем для создания красивых вложенностей, переменных цветов, миксинов и так далее.
        </li>
      </ul>
      <p>
        Библиотеки, с которыми надо будет работать:
      </p>
      <ul>
        <li>
          <a
